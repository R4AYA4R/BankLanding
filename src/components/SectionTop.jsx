                ...
                <div className="sectionTop__inner">
                    <div className="sectionTop__info">
                        <div className="info__subdiv">
                            <img src="BankLanding/images/sectionTop/Icon.png" alt="" className="subdiv__img" />
                    ...
                    <div className="sectionTop__moneyBlock">
                        <div className="moneyBlock__transactions">
                            ...
                            <img src="BankLanding/images/sectionTop/Container.png" alt="" className="transactions__img" />
                        </div>
                            ...
                            <div className="exchange__table">
                                <div className="table__IndianBlock">
                                    <div className="IndianBlock__titleImg">
                                        <img src="BankLanding/images/sectionTop/Image.png" alt="" className="titleImg__img" />
                                ...
                                <div className="table__USABlock">
                                    <div className="USABlock__titleImg">
                                        <img src="BankLanding/images/sectionTop/Image (1).png" alt="" className="titleImg__img" />
                        ...
                        <div className="sectionTop__income">
                            <img src="BankLanding/images/sectionTop/Icon Container.png" alt="" className="income__img" />
                    ...
                    <div className="sectionTop__currency">
                        ...
                        <div className="currency__images">
                            <img src="BankLanding/images/sectionTop/Icon (1).png" alt="" className="currency__images-img" />
                            <img src="BankLanding/images/sectionTop/Icon (2).png" alt="" className="currency__images-img" />
                            <img src="BankLanding/images/sectionTop/Icon (3).png" alt="" className="currency__images-img" />
                            <img src="BankLanding/images/sectionTop/Icon (4).png" alt="" className="currency__images-img" />
                        </div>
                    </div>
                </div>
            </div>
