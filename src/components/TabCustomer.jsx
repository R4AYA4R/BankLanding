const TabCustomer = ({tab}) => {
    return (
        <div className={tab === 'customer' ? "blocks__info blocks__info--active" : "blocks__info"}>
            <div className="blocks__info-item">
                <div className="info__item-blockImg">
                    <p className="info__item-title">24/7 Customer Support</p>
            ...
            <div className="blocks__info-item">
                <div className="info__item-blockImg">
                    <p className="info__item-title">Mobile Banking App For Customers</p>
                    <a href="#" className="info__item-link">
                        <img src="BankLanding/images/sectionFeatures/Icon.png" alt="" className="info__item-img" />
                    </a>
                </div>
            ...
            <div className="blocks__info-item">
                <div className="info__item-blockImg">
                    <p className="info__item-title">Secure Customers Transactions</p>
                    <a href="#" className="info__item-link">
                        <img src="BankLanding/images/sectionFeatures/Icon.png" alt="" className="info__item-img" />
                    </a>
                </div>
