                ...
                <div className="sectioProducts__inner">
                    ...
                    <div className="sectionProducts__blocks">
                        <div className="blocks__item blocks__item1">
                            <img src="/images/sectionProducts/Icon Container.png" alt="" className="blocks__item-img" />
                        ...
                        <div className="blocks__item blocks__item2">
                            <img src="/images/sectionProducts/Icon Container (1).png" alt="" className="blocks__item-img" />
                        ...
                        <div className="blocks__item blocks__item3">
                            <img src="/images/sectionProducts/Icon Container (2).png" alt="" className="blocks__item-img" />
